...
const AboutPage: React.FC = () => {
  ...
  return (
    <div className="space-y-32 py-20">
      ...
      >
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-heading font-bold text-gentle-green mb-8 tracking-tight">{t('about.title', { defaultValue: `About ${CLINIC_NAME}` })}</h1>
        <p className="text-xl md:text-3xl text-secondary-text font-body font-light leading-relaxed max-w-3xl mx-auto">
      ...
      >
        <div className="bg-pure-white rounded-[3rem] shadow-2xl overflow-hidden border border-gentle-green/10">
          <div className="grid md:grid-cols-2 items-stretch">
            <div className="p-10 md:p-20 flex flex-col justify-center relative">
              ...
              <h2 className="text-4xl md:text-5xl font-heading font-bold text-gentle-green mb-8 relative z-10 tracking-tight">{t('about.doctorTitle', { defaultValue: 'Meet Dr. Krishnendu Bhattacharya' })}</h2>
              <div className="space-y-8 font-body text-secondary-text text-lg leading-relaxed relative z-10">
                <p>
                  {t('about.doctorP1', { defaultValue: "Dr. Krishnendu Bhattacharya is a dedicated and compassionate dentist with a passion for creating beautiful, healthy smiles. With years of experience in various dental disciplines, Dr. Bhattacharya believes in a patient-centric approach, taking the time to understand each individual's needs and concerns." })}
                </p>
                <p>
            ...
            <div className="relative h-[500px] md:h-auto">
              <img 
                ...
                alt="Dr. Krishnendu Bhattacharya" 
                className="absolute inset-0 w-full h-full object-cover"
                referrerPolicy="no-referrer"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-gentle-green/40 to-transparent mix-blend-multiply"></div>
            </div>
          </div>
        </div>
      </motion.section>
      ...
      >
        <div className="text-center mb-20">
          <motion.h2 variants={fadeUpVariant} className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold text-gentle-green mb-8 tracking-tight">{t('about.clinicTitle', { defaultValue: 'Our Clinic Environment' })}</motion.h2>
          <motion.p variants={fadeUpVariant} className="font-body text-secondary-text text-xl max-w-4xl mx-auto leading-relaxed font-light opacity-90">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {[1, 2, 3].map((item) => (
            <motion.div 
              key={item} 
              variants={fadeUpVariant}
              className="group rounded-[2rem] overflow-hidden shadow-xl border border-gentle-green/10"
            >
        ...
        <motion.p variants={fadeUpVariant} className="font-body text-secondary-text text-center mt-16 text-xl max-w-4xl mx-auto leading-relaxed font-light">
      ...
      >
        <div className="bg-gradient-to-br from-gentle-green to-gentle-green/90 text-pure-white p-16 md:p-24 rounded-[3rem] shadow-2xl text-center relative overflow-hidden border border-gentle-green/20">
          ...
          <div className="relative z-10">
            <div className="flex justify-center mb-10">
              <Tooltip text={t('about.purposeTooltip', { defaultValue: 'Our core purpose' })}>
                <div className="bg-pure-white/10 p-6 rounded-full backdrop-blur-sm shadow-inner border border-pure-white/10">
                  <AboutPageIcon className="w-16 h-16 text-warm-coral" />
                </div>
              </Tooltip>
            </div>
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-8 tracking-tight drop-shadow-md">{t('about.purposeTitle', { defaultValue: 'Our Core Purpose' })}</h2>
            <p className="font-body text-xl md:text-2xl leading-relaxed opacity-90 font-light drop-shadow-sm">
